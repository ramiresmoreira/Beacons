...
static void native_to_managed_trampoline_39 (id self, SEL _cmd, MonoMethod **managed_method_ptr, UIActionSheet * p0, const char *r0, const char *r1, const char *r2)
{
	NSObject *nsobj0 = NULL;
	MonoObject *mobj0 = NULL;
	int32_t created0 = false;
...
static void native_to_managed_trampoline_40 (id self, SEL _cmd, MonoMethod **managed_method_ptr, UIActionSheet * p0, NSInteger p1, const char *r0, const char *r1, const char *r2, const char *r3)
{
	NSObject *nsobj0 = NULL;
	MonoObject *mobj0 = NULL;
	int32_t created0 = false;
...
static void native_to_managed_trampoline_45 (id self, SEL _cmd, MonoMethod **managed_method_ptr, UIRotationGestureRecognizer * p0, const char *r0, const char *r1, const char *r2)
{
	NSObject *nsobj0 = NULL;
	MonoObject *mobj0 = NULL;
	int32_t created0 = false;
...
@implementation UIKit_UIActionSheet__UIActionSheetDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_39 (self, _cmd, &managed_method, p0, "UIKit.UIActionSheet, Xamarin.iOS", "UIKit.UIActionSheet+_UIActionSheetDelegate, Xamarin.iOS", "Canceled");
	}

	-(void) actionSheet:(UIActionSheet *)p0 clickedButtonAtIndex:(NSInteger)p1
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_40 (self, _cmd, &managed_method, p0, p1, "UIKit.UIActionSheet, Xamarin.iOS", "System.nint, Xamarin.iOS", "UIKit.UIActionSheet+_UIActionSheetDelegate, Xamarin.iOS", "Clicked");
	}

	-(void) actionSheet:(UIActionSheet *)p0 didDismissWithButtonIndex:(NSInteger)p1
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_40 (self, _cmd, &managed_method, p0, p1, "UIKit.UIActionSheet, Xamarin.iOS", "System.nint, Xamarin.iOS", "UIKit.UIActionSheet+_UIActionSheetDelegate, Xamarin.iOS", "Dismissed");
	}

	-(void) didPresentActionSheet:(UIActionSheet *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_39 (self, _cmd, &managed_method, p0, "UIKit.UIActionSheet, Xamarin.iOS", "UIKit.UIActionSheet+_UIActionSheetDelegate, Xamarin.iOS", "Presented");
	}

	-(void) actionSheet:(UIActionSheet *)p0 willDismissWithButtonIndex:(NSInteger)p1
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_40 (self, _cmd, &managed_method, p0, p1, "UIKit.UIActionSheet, Xamarin.iOS", "System.nint, Xamarin.iOS", "UIKit.UIActionSheet+_UIActionSheetDelegate, Xamarin.iOS", "WillDismiss");
	}

	-(void) willPresentActionSheet:(UIActionSheet *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_39 (self, _cmd, &managed_method, p0, "UIKit.UIActionSheet, Xamarin.iOS", "UIKit.UIActionSheet+_UIActionSheetDelegate, Xamarin.iOS", "WillPresent");
	}
...
@implementation __UIRotationGestureRecognizer { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_45 (self, _cmd, &managed_method, p0, "UIKit.UIRotationGestureRecognizer, Xamarin.iOS", "UIKit.UIRotationGestureRecognizer+Callback, Xamarin.iOS", "Activated");
	}
@end
...
@implementation Xamarin_Forms_Platform_iOS_ContextActionsCell_MoreActionSheetDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_40 (self, _cmd, &managed_method, p0, p1, "UIKit.UIActionSheet, Xamarin.iOS", "System.nint, Xamarin.iOS", "Xamarin.Forms.Platform.iOS.ContextActionsCell+MoreActionSheetDelegate, Xamarin.Forms.Platform.iOS", "Clicked");
	}
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [12].handle = objc_getClass ("UIDatePicker");
	...
	__xamarin_class_map [49].handle = objc_getClass ("UIViewController");
	__xamarin_class_map [50].handle = objc_getClass ("UINavigationController");
	...
	__xamarin_class_map [56].handle = objc_getClass ("UIKit_UIControlEventProxy");
	...
	__xamarin_class_map [67].handle = objc_getClass ("UIRefreshControl");
	...
	__xamarin_class_map [71].handle = objc_getClass ("UISlider");
	__xamarin_class_map [72].handle = objc_getClass ("NSIndexSet");
	__xamarin_class_map [73].handle = objc_getClass ("UISpringTimingParameters");
	...
	__xamarin_class_map [83].handle = objc_getClass ("UITextPosition");
	...
	__xamarin_class_map [87].handle = objc_getClass ("UIAlertAction");
	...
	__xamarin_class_map [144].handle = objc_getClass ("__UIPanGestureRecognizer");
	...
	__xamarin_class_map [148].handle = objc_getClass ("__UIRotationGestureRecognizer");
	__xamarin_class_map [149].handle = objc_getClass ("__UITapGestureRecognizer");
	__xamarin_class_map [150].handle = objc_getClass ("__UIPinchGestureRecognizer");
	__xamarin_class_map [151].handle = objc_getClass ("__UISwipeGestureRecognizer");
	__xamarin_class_map [152].handle = objc_getClass ("__UIScreenEdgePanGestureRecognizer");
	...
	__xamarin_class_map [156].handle = objc_getClass ("UIKit_UIWebView__UIWebViewDelegate");
	__xamarin_class_map [157].handle = [Xamarin_Forms_Platform_iOS_iOS7ButtonContainer class];
	__xamarin_class_map [158].handle = [Xamarin_Forms_Platform_iOS_GlobalCloseContextGestureRecognizer class];
	__xamarin_class_map [159].handle = [Xamarin_Forms_Platform_iOS_ModalWrapper class];
	__xamarin_class_map [160].handle = [Xamarin_Forms_Platform_iOS_PlatformRenderer class];
	__xamarin_class_map [161].handle = [Xamarin_Forms_Platform_iOS_VisualElementRenderer_1 class];
	__xamarin_class_map [162].handle = [Xamarin_Forms_Platform_iOS_ViewRenderer_2 class];
	__xamarin_class_map [163].handle = [Xamarin_Forms_Platform_iOS_ViewRenderer class];
	__xamarin_class_map [164].handle = [Xamarin_Forms_Platform_iOS_CellTableViewCell class];
	__xamarin_class_map [165].handle = [Xamarin_Forms_Platform_iOS_ActivityIndicatorRenderer class];
	__xamarin_class_map [166].handle = [Xamarin_Forms_Platform_iOS_BoxRenderer class];
	__xamarin_class_map [167].handle = [Xamarin_Forms_Platform_iOS_NoCaretField class];
	__xamarin_class_map [168].handle = [Xamarin_Forms_Platform_iOS_EditorRenderer class];
	...
	__xamarin_class_map [173].handle = [Xamarin_Forms_Platform_iOS_FormsUITableViewController class];
	__xamarin_class_map [174].handle = [Xamarin_Forms_Platform_iOS_ProgressBarRenderer class];
	__xamarin_class_map [175].handle = [Xamarin_Forms_Platform_iOS_ScrollViewRenderer class];
	__xamarin_class_map [176].handle = [Xamarin_Forms_Platform_iOS_SearchBarRenderer class];
	__xamarin_class_map [177].handle = [Xamarin_Forms_Platform_iOS_SliderRenderer class];
	...
	__xamarin_class_map [180].handle = [Xamarin_Forms_Platform_iOS_TabbedRenderer class];
