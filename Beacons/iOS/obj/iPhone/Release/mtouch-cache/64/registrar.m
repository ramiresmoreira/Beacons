...
void xamarin_create_classes () {
	...
	__xamarin_class_map [23].handle = objc_getClass ("NSThread");
	...
	__xamarin_class_map [49].handle = objc_getClass ("EAGLContext");
	...
	__xamarin_class_map [53].handle = objc_getClass ("UIButton");
	__xamarin_class_map [54].handle = objc_getClass ("UIKit_UIControlEventProxy");
	__xamarin_class_map [55].handle = objc_getClass ("UICollectionView");
	__xamarin_class_map [56].handle = objc_getClass ("UICollectionViewLayout");
	__xamarin_class_map [57].handle = objc_getClass ("CKShareMetadata");
	...
	__xamarin_class_map [78].handle = objc_getClass ("NSNull");
	...
	__xamarin_class_map [86].handle = objc_getClass ("UITouch");
	...
	__xamarin_class_map [95].handle = objc_getClass ("UIVisualEffect");
	__xamarin_class_map [96].handle = objc_getClass ("UIVisualEffectView");
	...
	__xamarin_class_map [145].handle = objc_getClass ("UIKit_UIAlertView__UIAlertViewDelegate");
	__xamarin_class_map [146].handle = objc_getClass ("UIKit_UIBarButtonItem_Callback");
	__xamarin_class_map [147].handle = objc_getClass ("__UIRotationGestureRecognizer");
	__xamarin_class_map [148].handle = objc_getClass ("__UITapGestureRecognizer");
	__xamarin_class_map [149].handle = objc_getClass ("__UIPanGestureRecognizer");
